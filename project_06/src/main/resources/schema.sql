...
create table products_petrov_vv.clients (cart_id integer, id serial not null, email varchar(255), name varchar(255) not null, password varchar(255) not null, username varchar(255) not null, primary key (id));
