package ru.sber.project_08.security;

import ru.sber.project_08.security.jwt.AuthEntryPointJwt;
import ru.sber.project_08.security.jwt.AuthTokenFilter;
import ru.sber.project_08.security.services.UserDetailsServiceImpl;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers( "/shopping-carts/**").permitAll()
                                .requestMatchers(HttpMethod.OPTIONS, "/shopping-carts/**").permitAll()
